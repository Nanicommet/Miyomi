import { Plus, Package, Star, Github, MessageSquare, Facebook, Sparkles, Zap, Shield, BookOpen } from 'lucide-react';
...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const statMeta: Array<{
    ...
    },
    {
      ...
      path: '/communities',
      icon: Shield,
      gradient: 'from-[#C5F7E1] to-[#3DDC84]',
      glow: 'bg-[#C5F7E1]/35',
      glowAlt: 'bg-[#3DDC84]/25',
    },
  ];
